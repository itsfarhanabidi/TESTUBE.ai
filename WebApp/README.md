...
The database used to stored information of patient records is Sqlite3.
...
3) Diagnosis Window:  
    ...
    - There is also a sidebar where the doctor can shift to any other page of operation like:
          - Search & View Patients Window
